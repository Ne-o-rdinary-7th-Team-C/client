...
export default function First() {
  return (
    <div className={"h-screen py-[40px] px-[16px]"}>
      ...
      {/* <div className={'h-[48px]  text-white font-bold text-[16px] leading-[22px] rounded-small bg-primaryColor2 text-center'}>캘린더 생성하기</div> */}
      <Button className={"variant-primary size-lg"} value={"시작하기"} />
